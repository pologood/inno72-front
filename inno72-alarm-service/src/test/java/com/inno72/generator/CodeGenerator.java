...
public class CodeGenerator {
	// JDBC配置，请修改为你项目的实际配置
	private static final String JDBC_URL = "jdbc:mysql://192.168.33.243:3306/inno72_saas";
	...
	public static void main(String[] args) {
		genCode("alarm_deal_log", "alarm_detail_log", "alarm_msg_type", "alarm_rule", "alarm_rule_msg_type",
				"alarm_rule_receiver", "alarm_user");
	}
