...
public class Inno72MerchantTotalCountByDayController {
	...
	public Result searchData(@PathVariable(value = "label") String label, String sellerId,String activityId, String city, String startDate, String endDate, String goods) {
	...
	public Result searchDataExport(String label, String body,
			String activityId, String city, String startDate,
			String endDate, String goods,String sellerId,
