...
@Component
public class QrCodeRedisUtil {

	private static final Logger LOGGER = LoggerFactory.getLogger(QrCodeRedisUtil.class);

	public static final String SESSION_KEY = "session:";
	public static final Integer SESSION_EX = 1800;
	...
	public void setSessionEx(String sessionUuid, String value){
		...
		string().set(SESSION_KEY + sessionUuid, value , QrCodeRedisUtil.SESSION_EX, TimeUnit.SECONDS);
	}
