...
public class Inno72MachineServiceImpl extends AbstractService<Inno72Machine> implements Inno72MachineService {
	...
	public Result<Object> createQrCode(Integer machineId) {
		...
		//调用天猫的地址
		String url = "https://oauth.taobao.com/authorize?response_type=code&client_id=24791535&redirect_uri=https://inno72.ews.m.jaeapp.com/"+machineId+"?sessionUuid="+sessionUuid;
        //二维码存储在本地的路径
