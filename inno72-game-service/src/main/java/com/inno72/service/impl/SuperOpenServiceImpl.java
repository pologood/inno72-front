...
public class SuperOpenServiceImpl implements SuperOpenService {
	...
	public static enum ADPTE_METHOD {
		...
		ERROR_NO_VERSION("500", "ERROR_NO_VERSION", "/inno72/noVersion/open", "出货后调用减货", "1.0.0"), MALFUNCTION_LOG(
				"009", "malfunctionLog", "/api/malfunctionLog", "货道异常信息存储", "1.0.0"), /** 货道异常信息存储 */
