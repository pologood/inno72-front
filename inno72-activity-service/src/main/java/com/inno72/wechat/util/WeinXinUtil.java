package com.inno72.wechat.util;
...
public class WeinXinUtil {
    ...
    public static void main(String[] args) {
        String ticket = "HoagFKDcsGMVCIY2vOjf9gGeQtD2iwsDGZagZEghRbq1q2CGXqSykUJMemjylYHDztZxFDqH4TpfwTY0vL58gg";
        String url = "http://api.activity.36solo.com/index.html";
        Map<String, String> ret = Sign.sign(ticket, url);
        System.out.println(ret.get("signature"));
        System.out.println(ret.get("nonceStr"));
        System.out.println(ret.get("timestamp"));
    }
